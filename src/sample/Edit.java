...
public class Edit implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if(!entryToEdit.equals(null)) {
            moneySpentTextField.setText(String.valueOf(entryToEdit.getMoneySpent()));
            importanceTextField.setText(String.valueOf(entryToEdit.getImportance()));
            ExpenceEntryType expenceTypeDescription = entryToEdit.getEntryType();
            expenceEntryComboBox.getSelectionModel().select(expenceTypeDescription);
            descriptionField.setText(entryToEdit.getComment());
            datePicker.setValue(entryToEdit.getCalendar());
            setSpecification();
        }
    }
